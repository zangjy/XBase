...
package com.zjy.xbase.library.CustomActivityOnCrash;
...
import com.zjy.xbase.library.CustomActivityOnCrash.activity.DefaultErrorActivity;
import com.zjy.xbase.library.CustomActivityOnCrash.config.CaocConfig;
...
public final class CustomActivityOnCrash {
    ...
    private static final String EXTRA_CONFIG = "com.zjy.xbase.library.CustomActivityOnCrash.EXTRA_CONFIG";
    private static final String EXTRA_STACK_TRACE = "com.zjy.xbase.library.CustomActivityOnCrash.EXTRA_STACK_TRACE";
    private static final String EXTRA_ACTIVITY_LOG = "com.zjy.xbase.library.CustomActivityOnCrash.EXTRA_ACTIVITY_LOG";
    private static final String EXTRA_CUSTOM_CRASH_DATA = "com.zjy.xbase.library.CustomActivityOnCrash.EXTRA_CUSTOM_CRASH_DATA";

    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.zjy.xbase.library.CustomActivityOnCrash.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.zjy.xbase.library.CustomActivityOnCrash.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "com.zjy.xbase.library.CustomActivityOnCrash";
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.zjy.xbase.library.CustomActivityOnCrash.RESTART" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.zjy.xbase.library.CustomActivityOnCrash.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.zjy.xbase.library.CustomActivityOnCrash.ERROR" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.zjy.xbase.library.CustomActivityOnCrash.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
